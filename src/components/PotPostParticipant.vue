        ...
        <div class="flex-col">
          <div class="ation-container">
            ...
            <img
              ...
              src="img/variants-navigation-button-4@2x.svg"
              alt="Variants/Navigation Button"
            />
            </a>
            <div class="location">
              <div class="text-container">
                <div class="text-93 valign-text-middle dmsans-normal-eerie-black-14px">위치</div>
                <div class="text-94 valign-text-middle dmsans-normal-red-orange-15px">우리집</div>
              </div>
              <img class="vector-2" src="img/vector-2@2x.svg" alt="Vector 2" />
            </div>
          </div>
          <div class="view">
            <div class="overlap-group-1"><div class="text-97 dmsans-bold-black-24px"><img :src = "categories[pot.category]" style="position: relative; width: 50px; top: -9px; left: -13px;" /> </div></div>
            <div class="flex-col-1">
              <div class="overlap-group1">
                <div class="text-95 valign-text-middle dmsans-bold-masala-24px">{{pot.title}}</div>
                <div class="nn dmsans-bold-tropical-rain-forest-20px">{{Object.keys(pot.parties).length}}/{{pot.max}}</div>
              </div>
              <p class="text-96 valign-text-middle dmsans-medium-gunsmoke-15px">{{sexes[pot.sex]}} / {{pickups[pot.pickup]}}</p>
            </div>
          </div>
          <div class="overlap-group-container">
            <div class="overlap-group2">
              <div class="rectangle-10"></div>
              <div class="text-98 dmsans-normal-black-15px">{{pot.contents}}</div>
            </div>
...
.potpost-participants .overlap-group-container {
  height: 222px;
  margin-left: 14.0px;
  margin-top: 10px;
  position: relative;
